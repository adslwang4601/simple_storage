  ...
  */
  ...
  networks: {
    ...
    optimistic_kovan: {
      ...
      gas: 8950000,
      gasPrice: 20000000,
      from: '0x5eC32863EC68eF08892f32581D464F90BB7dd39A',
      value: 0,
      provider: function() {
        return new HDWalletProvider(kovanMnemonic, "https://optimism-kovan.infura.io/v3/"+ infuraKey);
      }
    },
